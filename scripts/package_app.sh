...
APP_NAME=${APP_NAME:-R3VIB3}
BUNDLE_ID=${BUNDLE_ID:-com.localtranscribepaste.app}
...
MIC_USAGE_DESCRIPTION=${MIC_USAGE_DESCRIPTION:-R3VIB3 needs microphone access to record dictation audio.}
...
<dict>
    ...
    <key>NSMicrophoneUsageDescription</key><string>${MIC_USAGE_DESCRIPTION}</string>
...
if [[ ! -d "$APP_RESOURCES_DIR" ]]; then
  APP_RESOURCES_DIR="$ROOT/LocalTranscribePaste/Resources"
fi
if [[ -d "$APP_RESOURCES_DIR" ]]; then
